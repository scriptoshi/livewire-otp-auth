...
namespace Scriptoshi\LivewireOtpAuth\Notifications;
...
class OTPActivation extends Notification implements ShouldQueue
{
    ...
    {
        $expirationTime = Config::get('livewire-otp-auth.expiration_time', 10);
        ...
        $mailMessage = (new MailMessage)
            ...
            ->line("This link will expire in {$expirationTime} minutes.");
