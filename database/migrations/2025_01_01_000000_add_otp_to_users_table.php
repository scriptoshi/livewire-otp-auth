...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('users', 'name') || 
                Schema::getConnection()->getDoctrineColumn('users', 'name')->getNotnull()) {
                $table->string('name')->nullable()->change();
            }
            
            if (!Schema::hasColumn('users', 'password') || 
                Schema::getConnection()->getDoctrineColumn('users', 'password')->getNotnull()) {
    ...
    public function down(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            // We won't revert the nullable changes to name and password
            // as this might break existing applications
        });
    }
};
